...
export default class App extends React.Component {
  ...
  openPortfolio() {
    Linking.openURL("https://stevendikowitz.com");
  }
  ...
  render() {
    if (this.state.loadApp) {
      return (
        <View style={styles.container}>
          <Image
            source={require("./App/Assets/chess.png")}
            style={styles.image}
          />
    ...
    if (this.state.gameOver) {
      headerText = <Text style={styles.turn}>Game Over, {player} wins!</Text>;
  ...
  turnComplete = () => {
    ...
    this.setState({
      turn:
        this.state.turn === CONSTANTS.WHITE ? CONSTANTS.BLACK : CONSTANTS.WHITE,
      gameOver: gameOver
    });
  };
}
